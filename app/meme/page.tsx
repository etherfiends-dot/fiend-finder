...
function MemeContent() {
  ...
  useEffect(() => {
    ...
    if (!encoded) {
      setError('No meme data provided');
      return;
    }
    ...
    try {
      ...
      setError('Failed to decode meme data');
    }
  }, [searchParams]);
    ...
    <main className="bg-slate-950 min-h-screen text-white p-4">
      <div className="max-w-lg mx-auto">
        ...
        <div className="text-center mb-4 pt-4">
          <h1 className="text-xl font-black tracking-tighter text-pink-400">
            NFT Meme
          </h1>
        </div>
